...
QString WelcomePageView::featuresTabContent() const
{
    ...
    newFeatures << i18n("Internal QtAVPlayer has been updated to the latest upstream 2026-02-28 which brings with it a variety of bug fixes and performance improvements (Qt5 only).");
