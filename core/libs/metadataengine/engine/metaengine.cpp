...
bool MetaEngine::initializeExiv2()
{
    ...
    registerXmpNameSpace(QLatin1String("http://ns.useplus.org/ldf/xmp/1.0/ImageCreator/plus/"),     // krazy:exclude=insecurenet
                         QLatin1String("plus_1_"));

    registerXmpNameSpace(QLatin1String("http://ns.useplus.org/ldf/xmp/1.0/ImageCreator/plus1/"),    // krazy:exclude=insecurenet
