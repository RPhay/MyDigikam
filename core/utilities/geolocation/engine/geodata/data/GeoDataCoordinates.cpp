...
QString GeoDataCoordinates::toString(GeoDataCoordinates::Notation notation, int precision) const
{
    ...
    if (notation == GeoDataCoordinates::UTM)
    {
        ...
        return QString::fromUtf8("%1%2 %3 m E, %4 m N").arg(zoneString, bandString, eastingString, northingString);
    }

    else if (notation == GeoDataCoordinates::Simply)
    {
        coordString = latToString(d->m_lat, notation, Radian, precision)
                      + QLatin1String(", ")
                      + lonToString(d->m_lon, notation, Radian, precision);
    }
                                        ...
                                        char format)
{
    if (notation == GeoDataCoordinates::UTM)
    {
        ...
        if (precision > 0)
        {
            ...
            result += QString::fromUtf8(" %1 m E").arg(eastingString);
        }
    ...
    if (notation == DMS || notation == DM)
    {
        ...
        {
            lonString += QString::fromUtf8(" %2\'").arg(lonMin, 2, 10, QLatin1Char('0'));
        }
        ...
        if (notation == DMS)
        {
            ...
            lonString += QString::fromUtf8(" %L3\"").arg(lonSecF, precision - 1, 'f', precision - 4, QLatin1Char('0'));
        }

        else
        {
            lonString += QString::fromUtf8(" %L3'").arg(lonMinF, precision + 1, 'f', precision - 2, QLatin1Char('0'));
        }
    }
    ...
    else // notation = GeoDataCoordinates::Simply
    {
        lonString = QString::fromUtf8("%1").arg(lon * RAD2DEG, 4 + precision, format, precision, QLatin1Char(' '));
        return lonString;
    }
                                        ...
                                        char format)
{
    if (notation == GeoDataCoordinates::UTM)
    {
        ...
        if (precision > 0)
        {
            ...
            result += QString::fromUtf8(" %1 m N").arg(northingString);
        }
    ...
    if (notation == DMS || notation == DM || notation == Astro)
    {
        ...
        {
            latString += QString::fromUtf8(" %2\'").arg(latMin, 2, 10, QLatin1Char('0'));
        }
        ...
        if (notation == DMS || notation == Astro)
        {
            ...
            latString += QString::fromUtf8(" %L3\"").arg(latSecF, precision - 1, 'f', precision - 4, QLatin1Char('0'));
        }

        else
        {
            latString += QString::fromUtf8(" %L3'").arg(latMinF, precision + 1, 'f', precision - 2, QLatin1Char('0'));
        }
    }
    ...
    {
        latString = QString::fromUtf8("%1").arg(lat * RAD2DEG, 4 + precision, format, precision, QLatin1Char(' '));
        return latString;
    }
