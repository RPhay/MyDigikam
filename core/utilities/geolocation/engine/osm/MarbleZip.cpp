...
class Q_DECL_HIDDEN LocalFileHeader
{
public:
...
class Q_DECL_HIDDEN EndOfDirectory
{
public:
...
/*!
    ...
    No error occurred.
    \var FileWriteError
    An error occurred when writing to the device.
    \var FileOpenError
    The file could not be opened.
    \var FilePermissionsError
...
/*!
    ...
    \var AlwaysCompress
    A file that is added is compressed.
    \var NeverCompress
