                             ...
                             bool isGeoProjected)
{
    ...
    else
    {
        ...
        if (
            !d->m_viewport->viewLatLonAltBox().intersects(ellipseBox) ||
                                        ...
                                        QVector<QPolygonF*>& polygons) const
{
    ...
    {
        // qCDebug(DIGIKAM_GEOENGINE_LOG) << "LineString doesn't get displayed on the viewport";
        return;
    }
                             ...
                             Qt::FillRule fillRule)
{
    ...
    // qCDebug(DIGIKAM_GEOENGINE_LOG) << "Drawing Polygon";
