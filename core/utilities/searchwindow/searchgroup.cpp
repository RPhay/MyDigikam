...
void SearchGroup::setup(Type type)
{
    ...
    group->addField(SearchField::createField(QLatin1String("nomake"),                       group));
    group->addField(SearchField::createField(QLatin1String("nomodel"),                      group));
    group->addField(SearchField::createField(QLatin1String("nolenses"),                     group));
